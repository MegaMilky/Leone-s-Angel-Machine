---
title: Archetypes Index
category: Index
tags: [archetypes, characters, index, navigation]
status: Auto-generated
last_updated: 2024-11-16
summary: "Master index of all archetypes and characters in Leone's Angel Machine"
---

# Archetypes Master Index

Mythic figures that populate and guide the Angel Machine universe.
...
## How Archetypes Connect to Philosophy

- **Passion** ↔ Taylor, Devil of Desire (personification)
- **Patience** ↔ Michael, The KlockWork Angel (timing)
- **Prophecy** ↔ Osiris & The Blind (fate reading & truth)
- **The Material** ↔ Shadow-Demon-Providence (integration)
- **There Are No Rules** ↔ All Archetypes (each breaks/rewrites rules)
...
4. Link to philosophical texts they embody
5. Update this index

---

*Last regenerated: 2024-11-16*
*Master index auto-generated from archetype metadata. Update individual files to change entries.*